...
<html lang="es">
    <head>
        ...
        <title><Hoteles class="net"></Hoteles></title>
    </head>
    <body>
                ...
                <div class="card-body">
                    <form class="form-login" id="frmLogin" name="frmLogin"  action="controlador/controlador_seguridad.php?opcion=1" method="POST" > 
                        <div class="form-group text-center" >
                            <h2 style="margin-bottom: 20px; color: #5F4C0B">Hoteles.net</h2>
                            <img src="/img/karsten-wurth-9qvZSH_NOQs-unsplash.jpg" height="150" width="100%"/>                        
                        </div>
